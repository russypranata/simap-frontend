...
export const DailyAttendanceView = ({
    students,
    date,
    setDate,
    searchTerm,
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    <CardTitle className="text-lg font-semibold">Presensi Pagi Harian</CardTitle>
                                ...
                                <CardDescription>
                                    Input dan konfirmasi presensi pagi siswa harian
                                </CardDescription>
                            </div>
                        </div>
