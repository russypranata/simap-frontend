...
interface AdminPhotoRequirementsModalProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    onProceed: () => void;
}

export const AdminPhotoRequirementsModal: React.FC<AdminPhotoRequirementsModalProps> = ({
    open,
    onOpenChange,
    onProceed,
}) => {
            ...
            <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                ...
                <div className="space-y-4 mt-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 mt-1.5">
                                        <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200 h-5 px-1.5 text-[10px]">
                                            <CheckCircle2 className="h-2.5 w-2.5 mr-1" /> .jpg
                                        </Badge>
                                        <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200 h-5 px-1.5 text-[10px]">
                                            <CheckCircle2 className="h-2.5 w-2.5 mr-1" /> .png
                                        </Badge>
                                        <Badge variant="outline" className="bg-red-50 text-red-700 border-red-200 h-5 px-1.5 text-[10px]">
                                            <XCircle className="h-2.5 w-2.5 mr-1" /> .gif
                                        </Badge>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="rounded-md border border-amber-800/20 bg-amber-50/50 p-5">
                        ...
                        <ul className="space-y-2 text-sm text-gray-700 pl-8">
                            ...
                            <li className="flex items-start gap-2">
                                <CheckCircle2 className="h-4 w-4 text-amber-700 mt-0.5 flex-shrink-0" />
                                <span className="leading-tight">
                                    Pencahayaan <strong>cukup dan merata</strong>
                                </span>
                            </li>
                            <li className="flex items-start gap-2">
                                <CheckCircle2 className="h-4 w-4 text-amber-700 mt-0.5 flex-shrink-0" />
                                <span className="leading-tight">
                                    Berpakaian <strong>rapi dan profesional</strong> (Batik atau Kemeja)
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t mt-6">
                        ...
                        <Button className="bg-blue-800 hover:bg-blue-900 text-white" onClick={onProceed}>
                            <CheckCircle2 className="h-4 w-4 mr-2" /> Mengerti, Lanjutkan
                        </Button>
                    </div>
                </div>
            </DialogContent>
