                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <CardDescription>Catatan pelanggaran yang pernah dilakukan anak</CardDescription>
                            </div>
                        </div>
                ...
                <CardContent>
                    {sortedRecords.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-sm text-green-600 mt-2 font-medium">Bagus! Anak Anda berkelakuan baik 👏</p>
                        </div>
                    ) : (
