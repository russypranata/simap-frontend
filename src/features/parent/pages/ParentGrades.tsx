...
export const ParentGrades: React.FC = () => {
    ...
    const {
        ...
        displaySemester,
        selectedChildId, setSelectedChildId,        selectedYearId, selectedSemester,
                    ...
                    {children.length > 1 && (
                        <Select value={selectedChildId} onValueChange={setSelectedChildId}>
                            <SelectTrigger className="w-auto h-9 bg-white shadow-sm border-slate-200 gap-2 px-3">
                                ...
                                <span className="text-sm text-slate-700 font-medium">{selectedChild?.name ?? children[0]?.name}</span>
                            </SelectTrigger>
                            <SelectContent>
                                {children.map(child => (
            ...
            <div className="space-y-6">
                ...
                <Tabs value={selectedTab} onValueChange={setSelectedTab} className="print:hidden">
                    ...
                    <TabsContent value="nilai" className="space-y-4 mt-4">
                        <AttendanceSection attendance={attendance} displaySemester={displaySemester} academicYear={activeYear?.year} />
