...
const MOCK_USERS: Record<string, LoginResponse['user']> = {
    'guru': { id: '1', username: 'guru', name: 'Budi Santoso, S.Pd', role: 'guru' },
    ...
    'tutor': { id: '5', username: 'tutor', name: 'Kak Tutor', role: 'tutor_ekskul' },
    'mutamayizin': { id: '6', username: 'mutamayizin', name: 'Ust. Mutamayizin', role: 'pj_mutamayizin' },
};
