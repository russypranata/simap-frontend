...
export const StudentProfile: React.FC = () => {
    ...
    const handlePrintPDF = () => {
        ...
        alert("Fitur Cetak akan membuka tab baru ke PDF dari server (Backend Implementation).");
    };

    const handleDownloadPDF = () => {
        // TODO: Replace with actual Laravel endpoint
        // window.open(`${process.env.NEXT_PUBLIC_API_URL}/student/${profileData?.id}/download-card`, '_blank');
        alert("Fitur Unduh akan mendownload PDF langsung dari server (Backend Implementation).");
    };
            ...
            <Card>
                <CardHeader className="pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <CardTitle className="text-lg">Statistik Akademik</CardTitle>
                            <p className="text-sm text-muted-foreground mt-0.5 font-normal">Ringkasan performa akademik Anda</p>
                        </div>
                    </div>
                </CardHeader>
                <CardContent>
                ...
                <CardContent>
                    ...
                    <div className="mb-6 p-4 rounded-lg bg-amber-50/50 border border-amber-100 flex gap-3 text-amber-900/80">
                        ...
                        <div className="space-y-1">
                            <h4 className="text-sm font-semibold text-amber-800">Mode Pratinjau (Preview)</h4>
                            <p className="text-xs sm:text-sm leading-relaxed">
                                Tampilan di bawah ini hanya simulasi visual. Hasil cetak/PDF akan memiliki resolusi tinggi (High Quality) dan barcode yang tajam sesuai standar kartu pelajar.
                            </p>
                        </div>
                    </div>
                                        ...
                                        <div className="absolute inset-0 z-10" style={{ fontFamily: "Arial, sans-serif" }}>
                                            ...
                                            <div style={{
                                                ...
                                                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                                                    <tbody>
                                                        <tr>
                                                            <td style={{ width: "110px", paddingBottom: "4px" }}>No Induk</td>
                                                            <td style={{ width: "20px", paddingBottom: "4px" }}>:</td>
                                                            <td style={{ paddingBottom: "4px" }}>{profileData.nis}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style={{ paddingBottom: "4px" }}>NISN</td>
                                                            <td style={{ paddingBottom: "4px" }}>:</td>
                                                            <td style={{ paddingBottom: "4px" }}>{profileData.nisn}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style={{ paddingBottom: "4px" }}>TTL</td>
                                                            <td style={{ paddingBottom: "4px" }}>:</td>
                                                            <td style={{ paddingBottom: "4px" }}>{profileData.birthPlace}, {profileData.birthDate}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style={{ paddingBottom: "4px" }}>Agama</td>
                                                            <td style={{ paddingBottom: "4px" }}>:</td>
                                                            <td style={{ paddingBottom: "4px" }}>{profileData.religion}</td>
                                                        </tr>
                                                        <tr>
