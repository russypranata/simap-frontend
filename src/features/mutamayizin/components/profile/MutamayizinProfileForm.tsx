...
interface MutamayizinProfileFormProps {
    initialData: MutamayizinProfileData;
    onSave: (data: MutamayizinProfileData) => void;
    onCancel: () => void;
    isLoading?: boolean;
}

export const MutamayizinProfileForm: React.FC<MutamayizinProfileFormProps> = ({
    initialData,
    onSave,
    onCancel,
    isLoading = false,
}) => {
    const [formData, setFormData] = useState<MutamayizinProfileData>(initialData);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-2">
                                ...
                                <Label htmlFor="programName" className="mb-0">
                                    Peran
                                </Label>
                            </div>
                            <Input
